...
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/Consulting-IT/sysmon-config/master/Auto_Update.bat','C:\ProgramData\sysmon\Auto_Update.bat')"
